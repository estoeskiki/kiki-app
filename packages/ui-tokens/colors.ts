// Ported verbatim from apps/kiosk/src/theme/themes.ts so the web ordering
// channel and the kiosk render the exact same brand palette. If you change a
// value here, change it there too (and packages/ui-tokens/tailwind.css).
