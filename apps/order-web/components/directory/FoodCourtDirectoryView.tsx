  ...
  return (
    <OrderingGate name={foodCourt.name} bgUrl={foodCourt.welcomeBgUrl} slogan={foodCourt.slogan}>
      <div className="min-h-dvh pb-4">
        ...
        {/* Solid lime, not the previous bg-primary/10 tint — this is the
            headline reason a food court is worth using, so it gets the same
            full-strength treatment as other highlighted callouts (Obligatorio
            pill, multi-restaurant banner). border-l-4 border-primary dropped:
            a lime border is invisible against an identical lime fill. */}
        <div className="fade-up-item mx-4 mt-3 flex flex-col gap-1 rounded-xl bg-primary px-4 py-3">
          <p className="font-body text-sm font-bold text-on-primary">
            Combina tus platos favoritos de diferentes restaurantes en un solo pedido.
          </p>
          <p className="font-body text-xs font-semibold text-on-primary/70">Pagas tu pedido en la entrega.</p>
        </div>
