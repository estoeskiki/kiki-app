...
// Conditional max: this group's allowed selection count depends on which
// option is chosen in another ("driver") group. Effective max =
// byOption[selected driver option] ?? defaultMax, capped by maxSelections.
